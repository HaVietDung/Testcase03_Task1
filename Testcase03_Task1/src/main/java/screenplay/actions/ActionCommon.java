...
public class ActionCommon {
  ...
  public String getValueByAttribute (Target targetLocators, String attributeName) {
        String valueAttribute = theActorInTheSpotlight().asksFor(Attribute.of(targetLocators).named(attributeName));
        return valueAttribute;
    }
    public void selectDropdown(Target targetLocators,String value){
        theActorInTheSpotlight().attemptsTo(SelectFromOptions.byValue(value).from(targetLocators));
    }
